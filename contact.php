      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            ...
            <a class="navbar-brand" href="index.html"><span><svg width="77" height="63" viewBox="1.047 0 106.773 90.279">
  ...
  <path fill="#C7CAD5" d="M49.7 20.2s1 15-12.2 22h21.3s-9.2-5-9-22z"/>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 bioH">
            <h1>Wanna Chat?</h1>
            <p>Fill out this form and we can get started.</p>
          </div>
          <div class="col-md-4">
    ...
    <div class="container">
      <div class="row row bioBack">
        ...
        <p>Phone</p> <input type="tel" id="phone" name="phone">
